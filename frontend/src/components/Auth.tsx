...
export default function Root() {
  ...
  switch (auth.activeNavigator) {
    case "signinSilent":
      setTimeout(() => EventBus.$dispatch("alert.show", { message: "Signing in...", severity: "info" }), 0); break;
    case "signoutRedirect":
      setTimeout(() => EventBus.$dispatch("alert.show", { message: "Signing out...", severity: "info" }), 0); break;
  }
